...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(!$erroPreenchimento ){
            ...
            $inserirAgendamento = "INSERT INTO Agendamentos (Usuarios_idUsuario, materiaAgend, dataAgend, horarioAgend)
                            VALUES (1, '$materiaAgend', '$dataAgend', '$horarioAgend')";
            ...
            if(mysqli_query($conn, $inserirAgendamento)){
                ...
                echo "
                    <div class='alert alert-success text-center'>Solicitação de intérprete efetuada com sucesso!</div>
