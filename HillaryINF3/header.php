...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark sticky-top" style="background-color:#2F4F4F;">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="formAgenda.php" title="Agendar um Horário">Agendamento</a>
                    </li>
                    <li class="nav-item">
