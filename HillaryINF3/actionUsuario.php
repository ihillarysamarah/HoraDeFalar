...
<?php
    ...
    $nomeUsuario = $tipoUsuario = $emailUsuario = $senhaUsuario = $confirmarSenhaUsuario = "";
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        //Validação do campo tipoUsuario utilizando a função empty
        if(empty($_POST["tipoUsuario"])){
            echo "<div class='alert alert-warning text-center'>O campo <strong>IDENTIFIQUE-SE</strong> é obrigatório!</div>";
            $erroPreenchimento = true;
        }
        else {
            $tipoUsuario = filtrar_entrada($_POST["tipoUsuario"]);
        }
        ...
        if(!$erroPreenchimento){
            ...
            $inserirUsuario = "INSERT INTO Usuarios (nomeUsuario, tipoUsuario, emailUsuario, senhaUsuario) VALUES ('$nomeUsuario', '$tipoUsuario', '$emailUsuario','$senhaUsuario')";
